package edu.unizg.foi.nwtis.asaric.vjezba_08_dz_3.pomocnici;

/**
 * Klasa GpsUdaljenostBrzina koja implementira metode za izracunavanje udaljenosti izmedu koordinata
 */
public class GpsUdaljenostBrzina {
	/**
     * Konstruktor klase GpsUdaljenostBrzina.
     */
    public GpsUdaljenostBrzina() {
    }
