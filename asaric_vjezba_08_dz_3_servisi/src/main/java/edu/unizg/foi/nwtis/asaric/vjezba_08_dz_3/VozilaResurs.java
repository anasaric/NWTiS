...
public class VozilaResurs {
	...
	private String posaljiKomanduPosluziteljuVozila(String komanda) {
		...
		this.adresaVozila = konfig.dajPostavku("app.vozila.adresa");
		this.mreznaVrataVozila = Integer.parseInt(konfig.dajPostavku("app.vozila.mreznaVrata"));
		var odgovor = MrezneOperacije.posaljiZahtjevPosluzitelju(this.adresaVozila, mreznaVrataVozila, komanda);
